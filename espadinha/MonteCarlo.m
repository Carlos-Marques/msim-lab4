...
% Gera matriz que vai conter os estados resultantes das simulações de Monte Carlo
...
for i=1:runs % realiza as M runs
    ...
    estado_inicial = randi([1,20]); % Gera um estado inicial aleatório
    ...
    % Vetor que conta as ocorrências de cada estado
